...
def train(args, train_dataset, eval_dataset, model, tokenizer, orig, privacy_engine):
    """ Train the model """
    record_result = []
...
def main():
    ...
    # Training
    if args.do_train:
        global_step, tr_loss = train(args, train_dataset, eval_dataset, model, tokenizer, origin_model_dict, privacy_engine)
